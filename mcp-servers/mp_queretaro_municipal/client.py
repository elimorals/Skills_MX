"""Cliente mp_queretaro_municipal — mock-first."""
...
NAMESPACE = "queretaro_mun"
CRED_VARS = []


class QueretaroMunClient:
    ...
    def consultar_multas(self, **kwargs) -> dict:
        ...
        if self._is_mock():
            return mark_simulated({
                ...
                "data": {"placeholder": True, "ns": "queretaro_mun", "kwargs_received": list(kwargs.keys())},
