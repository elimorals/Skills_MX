"""Cliente mp_tijuana_municipal — mock-first."""
...
NAMESPACE = "tijuana_mun"
CRED_VARS = []


class TijuanaMunClient:
    ...
    def consultar_multas(self, **kwargs) -> dict:
        ...
        if self._is_mock():
            return mark_simulated({
                ...
                "data": {"placeholder": True, "ns": "tijuana_mun", "kwargs_received": list(kwargs.keys())},
